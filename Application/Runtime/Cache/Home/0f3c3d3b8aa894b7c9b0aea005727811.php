...
<header>
    <nav>
        ...
        <a class="title">管家提醒</a>
        <a id="tel" href="tel:<?php echo ($tel[0]['phone']); ?>"><img src="/weimei/Public//images/tel.png"></a>
    </nav>
</header>

<div id="content" class="keeperwarn-con">
<?php if($warn == null): ?><div style="text-align:center"><font size="4" color="red">您还没有新的管家提醒！</font></div><?php endif; ?>
<?php if(is_array($warn)): foreach($warn as $key=>$value): ?><div class="content">
        <div class="warn-con">
            <h3><?php echo ($value['mei_name']); ?></h3>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($value['warn']); ?></p>
        </div>
