...
<body class=" theme-blue">
	...
	<div class="header">
        <h1 class="page-title">修改美容项目</h1>
        <ul class="breadcrumb">
            <li>美容项目管理</li>
            <li class="active">修改美容项目</li>
        </ul>
    </div>
	...
	<div class="main-content" style="min-height: 1350px;">
		<form enctype="multipart/form-data" action="<?php echo U('server_detail_modify_update',array('mei_id'=>$mei[0]['id']));?>" method="post" class="demoform" >
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="mei_name" id="mei_name" placeholder="必填项" value="<?php echo ($mei[0]['mei_name']); ?>" datatype="*" nullmsg="请填写项目名称！" errormsg="请填写项目名称！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">项目简介: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="jianjie" id="jianjie" placeholder="必填项" value=""  datatype="*" nullmsg="请填写项目简介！" errormsg="请填写项目简介！"><?php echo ($mei[0]['jianjie']); ?></textarea>
				</div>
			</div>
			<div class="form-group">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">原价: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="oldprice" id="oldprice" placeholder="必填项" value="<?php echo ($mei[0]['oldprice']); ?>" datatype="*" nullmsg="请填写原价！" errormsg="请填写原价！">
				</div>
			</div>
			<div class="form-group">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">价格: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="price" id="price" placeholder="必填项" value="<?php echo ($mei[0]['price']); ?>" datatype="*" nullmsg="请填写价格！" errormsg="请填写价格！">
				</div>
			</div>
			<div class="form-group">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">销量: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="sales" id="sales" placeholder="必填项" value="<?php echo ($mei[0]['sales']); ?>" datatype="n" nullmsg="请填写销量！" errormsg="销量只能是数字！">
				</div>
			</div>
<!--*********标题图片*************************标题图片********************标题图片*********************-->
			<div class="control-group">
				...
				<div class="col-md-12" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="one">
						    <img id='imghead1' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($mei[0]['pic_title']); ?>" style="max-width:130px;height:100px;"> 
						</a>
						<input id="title" name="title" class="input-medium" type="file" onChange="a(this)"  style="margin-bottom:10px; width:66px;">
					</div>
				</div>
			</div>
<!--*********项目图片*************************项目图片********************项目图片*********************-->
			<div class="control-group clearfix">
				...
				<div class="col-md-3" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="two">
						   <img id='imghead2' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($items[0]); ?>" style="max-width:130px;height:100px;">  
						</a>
						<input id="item1" name="item1" class="input-medium" type="file" onChange="b(this)"  style="margin-bottom:10px; width:66px;">
					</div>
				</div>
				<div class="col-md-3" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="three">
						    <img id='imghead3' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($items[1]); ?>" style="max-width:130px;height:100px;"> 
						</a>
						<input id="item2" name="item2" class="input-medium" type="file" onChange="c(this)"  style="margin-bottom:10px; width:66px;">
					</div>
				</div>
				<div class="col-md-3" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="four">
						    <img id='imghead4' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($items[2]); ?>" style="max-width:130px;height:100px;"> 
						</a>
						<input id="item3" name="item3" class="input-medium" type="file" onChange="d(this)"  style="margin-bottom:10px; width:66px;">
					</div>
				</div>
			</div>
<!--************步骤图片**********************步骤图片**********************步骤图片********************-->
            ...
            <div id="test" class="control-group clearfix">
               <input type="hidden" id="fldNum" name="fldNum" value="<?php echo count($czbz)/2; ?>"  />
               
               <!--<input type="text" name="pic1" id="pic1" />-->
               <div class="clearfix"><label for="insertimage"class="col-md-1 control-label" style="padding:0px 0px 5px 0px;">步骤图片:</label>	
                   <span onclick="addJiheInput();" style="padding: 4px 25px;background-color: #B77D7C;color: #fafafa;font-size: 13px;font-weight: bold;border-radius: 5px; cursor: pointer;">增加</span> <span onclick="delInput();" style="padding: 4px 25px;background-color: #EABBBB;color: #fafafa;font-size: 13px;font-weight: bold;border-radius: 5px; cursor: pointer;">删除</span>
               </div>		   
               <?php for($i=1; $i<=count($czbz)/2;$i++) { ?>
                <div class="col-md-2" id="test<?php  echo $i ?>" style="padding:0px 0px 10px 0px; margin-right: 20px;">
					<div class="controls">
						<a id="pic<?php  echo $i ?>">
						    <img id='img4' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php  echo $czbz[2*($i-1)] ?>" style="max-width:130px;height:100px;">
						</a>
						<input id="czbz<?php  echo $i ?>" name="czbz<?php  echo $i ?>" class="input-medium" type="file" onChange="ha(this)"  style="margin-bottom:10px; width:66px;" >
						<input type="text" name="step_detail<?php  echo $i ?>" id="step_detail<?php  echo $i ?>" value="<?php  echo $czbz[2*$i-1] ?>" />
					</div>
				</div>
               <?php } ?>              
            </div>
             ...
             <script type="text/javascript">
            	  var num1=document.getElementById("fldNum").value;
...
<!--************产品展示**********************产品展示**********************产品展示********************-->
			...
			<div id="cpdiv" class="control-group clearfix">
               <input type="hidden" id="cpnum" name="cpnum" value="<?php echo count($goods)/2; ?>"  />
              
               <!--<input type="text" name="pic1" id="pic1" />-->
               <div class="clearfix">
               <label for="insertimage"class="col-md-1 control-label" style="padding:0px 0px 5px 0px;">产品展示:</label>
               ...
               <?php for($i=1; $i<=count($goods)/2;$i++) { ?>
                <div class="col-md-2" id="cpdiv<?php  echo $i ?>" style="padding:0px 0px 10px 0px; margin-right: 20px;">
					<div class="controls">
						<a id="cppic<?php  echo $i ?>">
						    <img id='imghead5' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php  echo $goods[2*($i-1)] ?>" style="max-width:130px;height:100px;">
						</a>
						<input id="goods<?php  echo $i ?>" name="goods<?php  echo $i ?>" class="input-medium" type="file" onChange="UpCppic(this)"  style="margin-bottom:10px; width:66px;" >
						<input type="text" name="goods_detail<?php  echo $i ?>" id="goods_detail<?php  echo $i ?>" value="<?php  echo $goods[2*$i-1] ?>" />
					</div>
				</div>
               <?php } ?>              
            </div>
             ...
             <script type="text/javascript">
            	  var num2=document.getElementById("cpnum").value;
            	  function addcpdiv() {
                    if (num2 < 1) {
                       num2 = 1;
                    }
...
<!--*************************************************************************************************************************-->
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="timelong" id="timelong" placeholder="必填项" value="<?php echo ($mei[0]['timelong']); ?>" datatype="*" nullmsg="请填写服务时长！" errormsg="请填写服务时长！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">次数: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="cishu" id="cishu" placeholder="必填项" value="<?php echo ($mei[0]['cishu']); ?>" datatype="n" nullmsg="请填写疗程次数！" errormsg="疗程次数只能是数字！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">适宜人群: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="people" id="people" placeholder="必填项" value="<?php echo ($mei[0]['people']); ?>" datatype="*" nullmsg="请填写适宜人群！" errormsg="请填写适宜人群！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">注意事项: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="notice" id="notice" placeholder="必填项" value="" datatype="*" nullmsg="请填写注意事项！" errormsg="请填写注意事项！"><?php echo ($mei[0]['notice']); ?></textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="jifen" id="jifen" placeholder="必填项" value="<?php echo ($mei[0]['jifen']); ?>" datatype="n" nullmsg="请填写积分上限！" errormsg="积分上限只能是数字！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">备注: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="remark" id="remark"  value=""><?php echo ($mei[0]['remark']); ?></textarea>
				</div>
			</div>
			<div class="form-group">
...
<script>
	...
	$(document).ready(function() {
				$("select[name='server_id']").val("<?php echo ($mei[0]['server_id']); ?>");
