...
<body class=" theme-blue">
	...
	<div class="header">
        <h1 class="page-title">特权路径管理</h1>
        <ul class="breadcrumb">
            <li>特权路径管理</li> 
            <li class="active">特权路径管理</li>          
        </ul>
    </div>
	...
	<div class="main-content" style="height: 1350px;">
        <form enctype="multipart/form-data" action="<?php echo U('tqurl_modify_update',array('sid'=>$tqurl[0]['id']));?>" method="post" class="demoform" >
           <div class="form-group clearfix">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">特权路径: <span style="color:red">*</span></label>
				<div class="col-md-12" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txturl" id="txturl" value="<?php echo ($tqurl[0]['url']); ?>" datatype="url" nullmsg="请填写特权路径！" errormsg="特权路径的输入格式不正确！"
					>
				</div>
			</div>
