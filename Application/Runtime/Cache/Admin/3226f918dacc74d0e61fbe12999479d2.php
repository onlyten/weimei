...
<body class=" theme-blue">
	...
	<div class="main-content">
		<form enctype="multipart/form-data" action="<?php echo U('admin_delete_update');?>" method="post" >
           <div class="btn-toolbar list-toolbar col-md-12" style="margin-top: -20px;">
           <div class='col-md-2'> <a href="<?php echo U('admin_add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> 新增管理员</a></div>
			    　　　　　　　　　　　　　
	...
	<script type="text/javascript">
		$('.next_page').on('click', function() {
			...
			if (<?php echo ($page_now); ?> == <?php echo ($server_pagenum); ?>) {
				...
				location.href = "<?php echo U('admin_list',array('page_now'=>$page_now+1));?>";
			};
		});
		...
		$('.jump_button').on('click', function() {
			...
			if ( parseInt($('.jump_page').val()) < 1 || parseInt($('.jump_page').val()) > <?php echo ($server_pagenum); ?> ) {
				...
				location.href = "<?php echo U('admin_list');?>/page_now/"+$('.jump_page').val();
			};
		});
	</script>
