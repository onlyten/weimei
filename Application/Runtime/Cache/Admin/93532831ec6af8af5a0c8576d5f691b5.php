...
<body class=" theme-blue">
	...
	<div class="main-content" style="height: 1350px;">
        <form enctype="multipart/form-data" action="<?php echo U('order_modify_update',array('order_id'=>$order1[0]['id']));?>" method="post" class="demoform" >
           <div class="form-group">
			 ...
			 <div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">预约时间: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="mei_name" id="mei_name" value="<?php echo ($order1[0]['time']); ?>" readonly="readonly" style="background-color: #c0c0c0;">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">美容项目</label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="mei_name" id="mei_name" placeholder="必填项" value="<?php echo ($order1[0]['mei_name']); ?>" readonly="readonly" style="background-color: #c0c0c0;" >
				</div>
			</div>

			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">订单状态</label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<select class="chzn-select form-control" name="selstate" id="selstate">
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txtname" id="txtname" placeholder="必填项" value="<?php echo ($order1[0]['name']); ?>" datatype="*" nullmsg="请填写姓名！" errormsg="请填写姓名！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">电话: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txtphone" id="txtphone" placeholder="必填项" value="<?php echo ($order1[0]['mobile']); ?>" datatype="*" nullmsg="请填写电话！" errormsg="请填写正确的电话格式！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">地址: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txtaddr" id="txtaddr" placeholder="必填项" value="<?php echo ($order1[0]['address']); ?>" datatype="*" nullmsg="请填写地址！" errormsg="请填写地址！">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea name="txtnote" id="txtnote" class="form-control" value=""><?php echo ($order1[0]['remark']); ?></textarea>
				</div>
			</div>
