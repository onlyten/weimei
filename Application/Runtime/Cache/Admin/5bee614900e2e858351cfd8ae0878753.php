...
<body class=" theme-blue">
	...
	<div class="main-content" style="height: 1350px;">
        <form enctype="multipart/form-data" action="<?php echo U('qdcoinrule_add_update');?>" method="post" class="demoform" >
           <div class="form-group clearfix">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" style="background-color: #eee;" name="txtcoin" id="txtcoin" value="" datatype="n" nullmsg="请填写维美币！" errormsg="请填写维美币！"
					>
				</div>
			</div>
			 <div class="form-group clearfix">
				...
				<div class="input-group date form_date col-md-6" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="16" type="text"  value="" readonly name="txttimeto" id="txttimeto" datatype="*" nullmsg="请选择截止时间！" errormsg="请选择截止时间！" >
			...
			<a href="<?php echo U('qdcoinrule_list');?>" class="btn btn-danger"><i class="glyphicon glyphicon-list"></i> 返回列表</a>
				</div>
			</div>
