...
<body class=" theme-blue">
	...
	<div class="header">
        <h1 class="page-title">新增维美币活动</h1>
        <ul class="breadcrumb">
            <li>维美币活动</li>
            <li class="active">新增维美币活动</li>
        </ul>
    </div>
	...
	<div class="main-content" style="height: 1350px;">
		<form enctype="multipart/form-data" action="<?php echo U('coinactivity_add_update');?>" method="post" class="demoform" >
			<div class="form-group">
				...
				<input type="text" class="form-control" name="txttitle" id="txttitle" placeholder="必填项" value="" datatype="*" nullmsg="请填写活动标题！" errormsg="请填写活动标题！" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">简介 <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="txtintro" id="txtintro" placeholder="必填项" value="" datatype="*" nullmsg="请填写活动简介！" errormsg="请填写活动简介！"></textarea>
				</div>
			</div>
          <!--
			<div class="control-group">
				...
				<div class="col-md-12" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						...
						<input id="txttitlepic" name="txttitlepic" class="input-medium" type="file" onChange="a(this)"  style="margin-bottom:10px; width:auto;" datatype="*" nullmsg="请上传标题图片！" errormsg="请上传标题图片！">
					</div>
				</div>
			</div>
           -->
		...
		<div class="form-group clearfix">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">维美币数额<span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txtcoin" id="txtcoin" placeholder="必填项" value="" datatype="n" nullmsg="请填写维美币数额！" errormsg="维美币数额只能是数字！">
				</div>
			</div>
			<!--<div class="form-group">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">活动路径(url)<span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txturl" id="txturl" placeholder="必填项" value="" datatype="url" nullmsg="请填写活动url！" errormsg="请保证url的格式正确！">
				</div>
			</div>-->
			<div class="form-group clearfix">
				<label class="col-md-12 control-label " style="padding:0px 0px 5px 0px;">活动截止日期 <span style="color:red">*</span></label>
				<div class="input-group date form_date col-md-6 " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="16" type="text"  value="" readonly name="txttimein" id="txttimein" datatype="*" nullmsg="请选择截止时间！" errormsg="请选择截止时间！" >
       ...
       <!--<script>
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea style="width:600px;height:400px;" name="content" id="content" placeholder="必填项" value=""></textarea>
				</div>
			</div>
			-->
			...
			<div class="form-group">
				...
				<button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> 添 加</button>
