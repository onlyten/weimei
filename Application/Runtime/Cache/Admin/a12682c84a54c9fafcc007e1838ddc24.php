...
<body class=" theme-blue">
	...
	<div class="main-content" style="height: 1350px;">
		<form enctype="multipart/form-data" action="<?php echo U('admin_add_update');?>" method="post" class="demoform" >

		 			
			<div class="form-group clearfix">
				<label class="col-md-2 control-label" style="padding:0px 10px 5px 0px; text-align: right;">登录名<span style="color:red">*</span></label>
				<div class="col-md-4" style="padding:0px 0px 10px 0px;">
				<input type="text" class="form-control" name="txtname" id="txtname" placeholder="必填项" value="<?php echo ($userinfo[0]['name']); ?>" datatype="*" nullmsg="请填写登录名！" errormsg="请填写登录名！" >
				</div>
			</div>
			<div class="form-group clearfix">
				<label class="col-md-2 control-label" style="padding:0px 10px 5px 0px; text-align: right;">密码<span style="color:red">*</span></label>
				<div class="col-md-4" style="padding:0px 0px 10px 0px;">
				<input type="text" class="form-control" name="txtpass" id="txtpass" placeholder="必填项" value="<?php echo ($userinfo[0]['mobile']); ?>" datatype="*" nullmsg="请设置密码！" errormsg="请设置密码！" >
				</div>
			</div>
			...
			<div class="form-group">
				...
				<a href="<?php echo U('admin_list');?>" class="btn btn-danger" style="margin-left: 60px;"><i class="glyphicon glyphicon-list"></i> 返回列表</a>
				</div>
			</div>
		</form>
	</div>
