...
<body class=" theme-blue">
        ...
        <div class="sidebar-nav">
           <ul>
                <li><a href="<?php echo U('Systemset/systemset_modify');?>" data-target=".nav-header" class="nav-header" data-toggle="collapse"><i class="glyphicon glyphicon-th-list"></i> 系统设置</a></li>
            ...
            <ul>
                <li><a href="#" data-target=".system-menu" class="nav-header collapsed" data-toggle="collapse"><i class="glyphicon glyphicon-usd"></i> 美丽管家管理</a></li>
                <li><ul class="system-menu nav nav-list collapse in">
	...
	<div class="main-content">
		<form enctype="multipart/form-data" action="<?php echo U('coinactivity_delete_update');?>" method="post" >
           <div class="btn-toolbar list-toolbar col-md-12" style="margin-top: -20px;">　　　　　　　　　　　　　　　　　　　
			    <div class='col-md-2'> <a href="<?php echo U('coinactivity_add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> 添加活动</a></div>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-striped">
						...
						<tbody>
							<?php if(is_array($coinactivitys)): $i = 0; $__LIST__ = $coinactivitys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td> <input type="checkbox" name="delete_id[]" value="<?php echo ($vo['id']); ?>">&nbsp;&nbsp;<?php echo ($vo['id']); ?></td>
								<td><?php echo ($vo['title']); ?></td>
								<td><?php echo ($vo['acurl']); ?></td>
								<td><?php echo ($vo['addtime']); ?></td>															
								<td>
									<a href="<?php echo U('coinactivity_modify',array('sid'=>$vo['id']));?>">编辑</a>
								</td>
