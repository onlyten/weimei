...
<body class=" theme-blue">
	...
	<div class="header">
        <h1 class="page-title">编辑维美币活动</h1>
        <ul class="breadcrumb">
            <li>维美币活动</li>
            <li class="active">编辑维美币活动</li>
        </ul>
    </div>
	...
	<div class="main-content" style="height: 1350px;">
		<form enctype="multipart/form-data" action="<?php echo U('coinactivity_modify_update',array('sid'=>$coinactivity[0]['id']));?>" method="post" class="demoform" >
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">标题</label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
				<input type="text" class="form-control" name="txttitle" id="txttitle" placeholder="必填项" value="<?php echo ($coinactivity[0]['title']); ?>" datatype="*" nullmsg="请填写活动标题！" errormsg="请填写活动标题！" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">简介 <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="txtintro" id="txtintro" placeholder="必填项" datatype="*" nullmsg="请填写活动简介！" errormsg="请填写活动简介！">
					<?php echo ($coinactivity[0]['introduction']); ?></textarea>
				</div>
			</div>
          <!--
			<div class="control-group">
				...
				<div class="col-md-12" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="one">
						     <img id='imghead1' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($coinactivity[0]['titlepic']); ?>" style="max-width:130px;height:100px;"> 
						</a>
						<input id="txttitlepic" name="txttitlepic" class="input-medium" type="file" onChange="a(this)"  style="margin-bottom:10px; width:auto;" >
					</div>
				</div>
			</div>
           -->
			...
			<div class="form-group ">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">维美币数额<span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txtcoin" id="txtcoin" placeholder="必填项" value="<?php echo ($coinactivity[0]['coin']); ?>" datatype="n" nullmsg="请填写维美币数额！" errormsg="维美币数额只能是数字！">
				</div>
			</div>
			<div class="form-group clearfix">
			<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">活动路径(url)<span style="color:red">*</span></label>
				<div class="col-md-8" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="txturl" id="txturl" placeholder="必填项" value="<?php echo ($coinactivity[0]['acurl']); ?>" readonly="readonly" style="background-color: #ccc;">
				</div>
			</div>

			<div class="form-group clearfix">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">活动有效期 <span style="color:red">*</span></label>
				<div class="input-group date form_date col-md-6 " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="16" type="text" style="background-color: #fff;"  value="<?php echo ($coinactivity[0]['timelong']); ?>" readonly name="txttimein" id="txttimein" datatype="*" nullmsg="请选择截止时间！" errormsg="请选择截止时间！" >
       ...
       <!--<script>
			...
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">活动详情 <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea style="width:600px;height:400px;" name="content" id="content" placeholder="必填项" value=""><?php echo ($coinactivity[0]['content']); ?></textarea>
				</div>
			</div>
			-->
			...
			<div class="form-group">
				...
				<a href="<?php echo U('coinactivity_list');?>" class="btn btn-danger" style="margin-left: 60px;"><i class="glyphicon glyphicon-list"></i> 返回列表</a>
				</div>
			</div>
		</form>
	</div>
