...
<body class=" theme-blue">
	...
	<div class="header">
        <h1 class="page-title">修改美丽管家</h1>
        <ul class="breadcrumb">
            <li>美丽管家管理</li>
            <li class="active">修改美丽管家</li>
        </ul>
    </div>
	...
	<div class="main-content" style="height: 1350px;">
		<form enctype="multipart/form-data" action="<?php echo U('housekeeper_modify_update',array('housekeeper_id'=>$housekeeper[0]['id']));?>" method="post" class="demoform" >
            ...
            <div class="form-group">
				...
				<div class="col-md-2" style="padding:0px 0px 10px 0px;">
                    <input type="radio" name="shuxing" value="0" "<?php if($housekeeper[0]['type']=='0'){ ?>" checked="checked"  " <?php } ?>"/>  院内</div>
                <div class="col-md-2" style="padding:0px 0px 10px 0px;">
                    <input type="radio" name="shuxing" value="1" "<?php if($housekeeper[0]['type']=='1'){ ?>" checked="checked"  " <?php } ?>" />  院外
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="job_num" id="job_num" placeholder="必填项" value="<?php echo ($housekeeper[0]['job_num']); ?>" datatype="*" nullmsg="请填写工号！" errormsg="请填写工号！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">姓名: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="name" id="name" placeholder="必填项" value="<?php echo ($housekeeper[0]['name']); ?>" datatype="*" nullmsg="请填写姓名！" errormsg="请填写姓名！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">职称等级: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="title" id="title" placeholder="必填项" value="<?php echo ($housekeeper[0]['title']); ?>" datatype="*" nullmsg="请填写职称等级！" errormsg="请填写职称等级！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">学历: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="xueli" id="xueli" placeholder="必填项" value="<?php echo ($housekeeper[0]['xueli']); ?>" datatype="*" nullmsg="请填写学历！" errormsg="请填写学历！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">客户评价: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="pingjia" id="pingjia" placeholder="请填写0~100之间的客户评价！" value="<?php echo ($housekeeper[0]['pingjia']); ?>" datatype="n" nullmsg="请填写客户评价！" errormsg="请填写客户评价！" maxlength="3">
				</div>
			</div>
...
<!--*********头像图片*************************头像图片********************头像图片*********************-->
			<div class="control-group">
				...
				<div class="col-md-12" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="one">
						    <img id='imghead1' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($housekeeper[0]['pic_tou']); ?>" style="max-width:130px;height:100px;"> 
						</a>
						<input id="pic_tou" name="pic_tou" class="input-medium" type="file" onChange="a(this)"  style="margin-bottom:10px; width:66px;">
					</div>
				</div>
			</div>
<!--*********形象照图片*************************形象照图片********************形象照图片*********************-->
			<div class="control-group">
				...
				<div class="col-md-3" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="two">
						   <img id='imghead2' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($pic_xing[0]); ?>" style="max-width:130px;height:100px;">  
						</a>
						<input id="pic_xing1" name="pic_xing1" class="input-medium" type="file" onChange="b(this)"  style="margin-bottom:10px; width:66px;">
					</div>
				</div>
				<div class="col-md-3" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="three">
						<?php if(strlen($pic_xing[1])>0){ ?>
						    <img id='imghead3' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($pic_xing[1]); ?>" style="max-width:130px;height:100px;">
						    <?php } else{ ?> 
                               <img id='imghead3'  style="max-width:130px;height:100px;">
						    <?php } ?>
						</a>
				...
				<div class="col-md-3" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="four">
						<?php if(strlen($pic_xing[2])>0){ ?>
						    <img id='imghead4' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($pic_xing[2]); ?>" style="max-width:130px;height:100px;"> 
						 <?php } else{ ?>
                          <img id='imghead4'  style="max-width:130px;height:100px;">
						 <?php } ?>
						</a>
...
<!--************资质证书图片**********************资质证书图片**********************资质证书图片********************-->
			<div class="control-group">
				...
				<div class="col-md-2" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="five">
						    <img id='imghead5' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($zzzs[0]); ?>" style="max-width:130px;height:100px;"> 
						</a>
						<input id="zzzs1" name="zzzs1" class="input-medium" type="file" onChange="e(this)"  style="margin-bottom:10px; width:66px;">
						<input type="text" name="step_detail1" id="step_detail1" value="<?php echo ($zzzs[1]); ?>" />
					</div>
				</div>
				<div class="col-md-2" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="six">
						<?php if(strlen($zzzs[2])>0){ ?>
						    <img id='imghead6' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($zzzs[2]); ?>" style="max-width:130px;height:100px;"> 
						<?php } else{ ?>
                          <img id='imghead6' style="max-width:130px;height:100px;">
						<?php } ?>

						</a>
						<input id="zzzs2" name="zzzs2" class="input-medium" type="file" onChange="f(this)"  style="margin-bottom:10px; width:66px;">
						<input type="text" name="step_detail2" id="step_detail2" value="<?php echo ($zzzs[3]); ?>" />
					</div>
				</div>
				<div class="col-md-2" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="seven">
						<?php if(strlen($zzzs[4])>0){ ?>
						    <img id='imghead7' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($zzzs[4]); ?>" style="max-width:130px;height:100px;">
						<?php } else{ ?>
                          <img id='imghead7' style="max-width:130px;height:100px;">
						<?php } ?>    
						</a>
						<input id="zzzs3" name="zzzs3" class="input-medium" type="file" onChange="g(this)"  style="margin-bottom:10px; width:66px;">
						<input type="text" name="step_detail3" id="step_detail3" value="<?php echo ($zzzs[5]); ?>" />
					</div>
				</div>
				<div class="col-md-2" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="eight">
						<?php if(strlen($zzzs[6])>0){ ?>
						    <img id='imghead8' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($zzzs[6]); ?>" style="max-width:130px;height:100px;"> 
						<?php } else{ ?>
                          <img id='imghead8' style="max-width:130px;height:100px;">
						<?php } ?>   
						</a>
						<input id="zzzs4" name="zzzs4" class="input-medium" type="file" onChange="h(this)"  style="margin-bottom:10px; width:66px;">
						<input type="text" name="step_detail4" id="step_detail4" value="<?php echo ($zzzs[7]); ?>" />
					</div>
				</div>
				<div class="col-md-2" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="nine">
						<?php if(strlen($zzzs[8])>0){ ?>					
						   <img id='imghead9' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($zzzs[8]); ?>" style="max-width:130px;height:100px;"> 
						<?php } else{ ?>
                          <img id='imghead9' style="max-width:130px;height:100px;">
						<?php } ?>   
						</a>
						<input id="zzzs5" name="zzzs5" class="input-medium" type="file" onChange="i(this)"  style="margin-bottom:10px; width:66px;">
						<input type="text" name="step_detail5" id="step_detail5" value="<?php echo ($zzzs[9]); ?>" />
					</div>
				</div>
			</div>
...
<!--*************************************************************************************************************************-->
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="cishu" id="cishu" placeholder="必填项" value="<?php echo ($housekeeper[0]['cishu']); ?>" datatype="n" nullmsg="请填写累计服务次数！" errormsg="累计服务次数只能是数字！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">顾客打赏: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="dashang" id="dashang" placeholder="必填项" value="<?php echo ($housekeeper[0]['dashang']); ?>" datatype="n" nullmsg="请填写顾客打赏！" errormsg="顾客打赏只能是数字！">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">任职经历: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="rzjl" id="rzjl" placeholder="必填项" value="" datatype="*" nullmsg="请填写任职经历！" errormsg="请填写任职经历！"><?php echo ($housekeeper[0]['rzjl']); ?></textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">擅长项目: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<textarea type="text" class="form-control" name="scxm" id="scxm"  value=""><?php echo ($housekeeper[0]['scxm']); ?></textarea>
				</div>
			</div>
			<div class="form-group">
...
//图片上传9
		...
		file.select();
		var src = document.selection.createRange().text;
		div.innerHTML = '<img id=czbz5>';
		var img = document.getElementById('czbz5');
		img.filters.item('DXImageTransform.Microsoft.AlphaImageLoader').src = src;
		var rect = clacImgZoomParam(MAXWIDTH, MAXHEIGHT, img.offsetWidth, img.offsetHeight);
		status =('rect:'+rect.top+','+rect.left+','+rect.width+','+rect.height);
		div.innerHTML = "<div id=divhead style='width:"+rect.width+"px;height:"+rect.height+"px;margin-top:"+rect.top+"px;"+sFilter+src+"\"'></div>";
