...
<body class=" theme-blue">
	...
	<div class="main-content" style="height: 1350px;">
        <form enctype="multipart/form-data" action="<?php echo U('qdcoinrule_modify_update',array('sid'=>$coinrule[0]['id']));?>" method="post" class="demoform" >
           <div class="form-group clearfix">
				<label class="col-md-12 control-label" style="padding:0px 0px 5px 0px;">签到送币: <span style="color:red">*</span></label>
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" style="background-color: #eee;" name="txtcoin" id="txtcoin" value="<?php echo ($coinrule[0]['coins']); ?>" datatype="n" nullmsg="请填写维美币！" errormsg="请填写维美币！"
					>
				</div>
			</div>
			 <div class="form-group clearfix">
				...
				<div class="input-group date form_date col-md-6" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="16" type="text"  value="<?php echo ($coinrule[0]['timeto']); ?>" readonly name="txttimeto" id="txttimeto">
