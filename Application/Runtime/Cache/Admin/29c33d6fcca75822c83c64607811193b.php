...
<body class=" theme-blue">
	...
	<div class="main-content">
		<form enctype="multipart/form-data"  action="<?php echo U('server_modify_update',array('server_id'=>$server[0]['id']));?>" method="post" class="demoform" >
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="server_name" id="server_name" placeholder="" value="<?php echo ($server[0]['server_name']); ?>" datatype="*" nullmsg="请填写类型名称！" errormsg="请填写类型名称！">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<input type="text" class="form-control" name="server_weight" id="server_weight" placeholder="" value="<?php echo ($server[0]['server_weight']); ?>" datatype="n" nullmsg="请填写排序！" errormsg="排序必须为数字！" >
				</div>
			</div>
			<div class="control-group">
				...
				<div class="col-md-6" style="padding:0px 0px 10px 0px;">
					<div class="controls">
						<a id="preview">
						    <img id='imghead1' src="http://serv2.matesofts.com/weimei/Public/upload/img/<?php echo ($server[0]['server_img']); ?>" style="max-width:200px;height:auto;">
						</a>
		...
		return param;
			...
			$(document).ready(function() {
				$("input[name='server_type'][value='<?php echo ($server[0]['server_type']); ?>']").attr("checked",true);
			});
		</script>
		<!-- 表单验证 -->
		<script type="text/javascript">
